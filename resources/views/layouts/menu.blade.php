...
<li>
    ...
    <ul id="adminsMenu" class="collapse">
        <li class=""><a href="/convocatorias/create">Crear convocatoria</a></li>
        <li class=""><a href="/convocatorias">Ver convocatoria</a></li>
        <li class=""><a href="/reclamos">Ver Reclamos</a></li>
...
<li>
    ...
    <ul id="usuarioMenu" class="collapse">
        <li class=""><a href="/usuarios/create">Crear usuario</a></li>
        <li class=""><a href="/usuarios">Ver Usuarios</a></li>
    </ul>
</li>
...
<li>
    ...
    <ul id="rolMenu" class="collapse">
        <li class=""><a href="/roles/create">Crear Rol</a></li>
        <li class=""><a href="/roles">Ver Roles</a></li>
    </ul>
</li>

<!--Menus del Oprador-->
<li>
    <a href="javascript:void(0)" onclick="toggleOpeMenu()" aria-expanded="false">
        <i class="fas fa-user"></i><span>Operador</span></a>
    <ul id="opeMenu" class="collapse">
        <li class=""><a href="/clientes/create">Crear Cliente</a></li>
        <li class=""><a href="/asignaciones/create">Asignar sitios</a></li>
        <li class=""><a href="/clientes">Ver Clientes</a></li>
        <li class=""><a href="/asignaciones">Ver Asignaciones</a></li>
    </ul>
</li>
...
<li>
    ...
    <ul id="parkMenu" class="collapse">
        ...
        <li class=""><a href="/parqueos">Ver Parqueos</a></li>
    </ul>
</li>
...
<script>
    ...
    function toggleOpeMenu() {
        $('#opeMenu').toggleClass('show');
        var expanded = $('#opeMenu').hasClass('show');
        $('a[aria-expanded="false"]').attr('aria-expanded', expanded);
    }
</script>